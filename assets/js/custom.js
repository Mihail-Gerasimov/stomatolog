...
const btnShowPhoneDec = document.getElementById('btn-show-phone');
const btnShowPhoneMobile = document.querySelector('.red-arrow_mob-show-phone');

const phoneContainerDec = document.querySelector('.call-container_dec');
const phoneContainerMob = document.querySelector('.call-container_mobile');


const btnShowInfoCitisDec = document.getElementById('btn-show-info');
const btnShowInfoCitisMob = document.querySelector('.red-arrow_str-mobile')

const linkContanerDec = document.querySelector('.link-box');
const linkContanerMob = document.querySelector('.link-box_mob');


btnShowInfoCitisDec.onclick = function() {
    linkContanerDec.classList.toggle('link-box-show');
}
btnShowInfoCitisMob.onclick = function() {
    linkContanerMob.classList.toggle('link-box-show');
    phoneContainerMob.classList.remove('call-container-show');
}

btnShowPhoneDec.onclick = function() {
    phoneContainerDec.classList.toggle('call-container-show');
}

btnShowPhoneMobile.onclick = function() {
    phoneContainerMob.classList.toggle('call-container-show');
    linkContanerMob.classList.remove('link-box-show');
}